...
const sendConnectionRequestReamainder = inngest.createFunction(
...
// inngest fuction to delete a story after 24 hour
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
    ...
    async({step}) => {
        ...
        messages.map(message=> {
            unseenCount[message.to_user_id._id] = (unseen[message.to_user_id._id] || 0)
            + 1;
        })
        for(const userId in unseenCount){
            ...
            const body = `
            <div style= "font-family:Arial, sans-serrif; padding: 20px">
...
export const functions = [
    ...
    syncUserUpdation,
    syncUserDeletion,
    sendConnectionRequestReamainder,
    deleteStory,
